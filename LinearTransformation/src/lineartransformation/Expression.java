...
public class Expression {
    ...
    public static double parseExpression(String newExpression) throws Exception{
        newExpression = newExpression.replaceAll("sqrt", "sqt");
        Expression e = new Expression(newExpression, 1,1);
        return e.resolve();
    }
