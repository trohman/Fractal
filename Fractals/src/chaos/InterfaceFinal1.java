 ...
 * @author Rohman
 */
public class InterfaceFinal1 extends javax.swing.JFrame {

    /** Creates new form Interface */
    public InterfaceFinal1() {
    ...
    private void initComponents() {
        ...
        display = new SmallPlot(1501,1001);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new InterfaceFinal1().setVisible(true);
                    display.initPaint();
                    display.init();
                    display.run();
